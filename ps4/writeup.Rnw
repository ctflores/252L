...
Interestingly, there are also a handful of items with statistically significant negative $\beta_2$ values, indicating that students in the top 50\% of readers found those items more difficult. 
