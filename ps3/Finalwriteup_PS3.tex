...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file 'emp-rasch.txt': No such file or directory}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(x): object 'respk' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(x): object 'respk' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(x): object 'respk' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is(object, "{}DiscreteClass"{}): object 'modk1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'thk1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is(object, "{}DiscreteClass"{}): object 'modk2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'thk2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is(object, "{}DiscreteClass"{}): object 'modk3' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'thk3' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in jitter(thk1): object 'thk1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in jitter(thk2): object 'thk2' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in if (length(unique(colnames(data))) != ncol(data)) stop("{}items must have unique names in data input"{}, : argument is of length zero}}\end{kframe}
